//==============================================================================
// lpi_pchannel_master_monitor.sv
// P-Channel MASTER-side monitor : decodes the interface state every clock and
// publishes a transaction on each state change. Belongs to the master agent.
//==============================================================================
class lpi_pchannel_master_monitor extends uvm_monitor;
  `uvm_component_utils(lpi_pchannel_master_monitor)
  ...
  task run_phase(uvm_phase phase);
    ...
    forever begin
      ...
      if (curr != prev) begin
        lpi_pchannel_item it = lpi_pchannel_item::type_id::create("mas_mon_it");
        it.prev_state = prev;
        it.curr_state = curr;
