//==============================================================================
// lpi_pchannel_slave_seq.sv
// P-Channel SLAVE = DEVICE responder BASE sequence.
// Forever supplies an accept/deny decision for each transition request.
...
//==============================================================================
class lpi_pchannel_slave_seq extends uvm_sequence #(lpi_pchannel_item);
  `uvm_object_utils(lpi_pchannel_slave_seq)

  bit deny_script[$];

  function new(string name="lpi_pchannel_slave_seq"); super.new(name); endfunction
