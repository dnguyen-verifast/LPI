//==============================================================================
// lpi_p_deny_test.sv  -  P-Channel, device always denies.
//==============================================================================
class lpi_p_deny_test extends lpi_base_test;
  `uvm_component_utils(lpi_p_deny_test)
  ...
  task run_phase(uvm_phase phase);
    lpi_p_deny_vseq vseq;
    phase.raise_objection(this);
    vseq = lpi_p_deny_vseq::type_id::create("vseq");
